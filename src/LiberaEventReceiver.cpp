...
//  FinalizeSynchronization  |  finalize_synchronization
...
//    m_libera->AddScalarPM("boards.raf3.sensors.ID_2.value",
...
//        attr_Temp2_read, LiberaAttr::DBL2SHORT);
    m_libera->AddScalarPM("boards.evrx2.sensors.ID_6.value",
        attr_Temperature_read, LiberaAttr::DBL2SHORT);
...
//        attr_FreeMemory_read, LiberaAttr::MEM2LONG);
    ...
    //m_libera->AddScalar("boards.gdx1.local_timing.sync_state_machine", attr_SynchronizationStatus_read);
    ...
    m_libera->AddScalar(tim + "rtc.sfp_2_connectors.t0.in_function",
    		attr_T0idOut_read, LiberaAttr::SPEC2LONG,LiberaAttr::LONG2SPEC);
...
void LiberaEventReceiver::get_device_property()
{
	...
	dev_prop.push_back(Tango::DbDatum("T0idOut"));
	...
	if (dev_prop.size()>0)
	{
		...
		//	Try to initialize T0idOut from class property
		cl_prop = ds_class->get_class_property(dev_prop[++i].name);
		if (cl_prop.is_empty()==false)	cl_prop  >>  t0idOut;
		else {
			//	Try to initialize T0idOut from default device value
			def_prop = ds_class->get_default_device_property(dev_prop[i].name);
			if (def_prop.is_empty()==false)	def_prop  >>  t0idOut;
		}
		//	And try to extract T0idOut value from database
		if (dev_prop[i].is_empty()==false)	dev_prop[i]  >>  t0idOut;
...
void LiberaEventReceiver::read_LiberaModel(Tango::Attribute &attr)
{
	...
	/*----- PROTECTED REGION ID(LiberaEventReceiver::read_LiberaModel) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_LiberaModel_read);
	
	/*----- PROTECTED REGION END -----*/	//	LiberaEventReceiver::read_LiberaModel
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void LiberaEventReceiver::read_Temperature(Tango::Attribute &attr)
{
	DEBUG_STREAM << "LiberaEventReceiver::read_Temperature(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(LiberaEventReceiver::read_Temperature) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_Temperature_read);
	
	/*----- PROTECTED REGION END -----*/	//	LiberaEventReceiver::read_Temperature
}
//--------------------------------------------------------
/**
...
//--------------------------------------------------------
/**
 *	Read attribute T0idOut related method
 ...
 */
//--------------------------------------------------------
void LiberaEventReceiver::read_T0idOut(Tango::Attribute &attr)
{
	DEBUG_STREAM << "LiberaEventReceiver::read_T0idOut(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(LiberaEventReceiver::read_T0idOut) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_T0idOut_read);
	
	/*----- PROTECTED REGION END -----*/	//	LiberaEventReceiver::read_T0idOut
}
//--------------------------------------------------------
/**
 *	Write attribute T0idOut related method
 *	Description: T0 Function array (in_function) contains 16-bit entries that define the value of masked bits.
 *
 *	Data type:	Tango::DevLong
 *	Attr type:	Scalar
 */
//--------------------------------------------------------
void LiberaEventReceiver::write_T0idOut(Tango::WAttribute &attr)
{
	DEBUG_STREAM << "LiberaEventReceiver::write_T0idOut(Tango::WAttribute &attr) entering... " << endl;
	//	Retrieve write value
	Tango::DevLong	w_val;
	attr.get_write_value(w_val);
	/*----- PROTECTED REGION ID(LiberaEventReceiver::write_T0idOut) ENABLED START -----*/
	
	m_libera->UpdateScalar(attr_T0idOut_read, w_val);
	/*----- PROTECTED REGION END -----*/	//	LiberaEventReceiver::write_T0idOut
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void LiberaEventReceiver::read_T2ID(Tango::Attribute &attr)
{
	DEBUG_STREAM << "LiberaEventReceiver::read_T2ID(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(LiberaEventReceiver::read_T2ID) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_T2ID_read);
	
	/*----- PROTECTED REGION END -----*/	//	LiberaEventReceiver::read_T2ID
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void LiberaEventReceiver::write_T2ID(Tango::WAttribute &attr)
{
	DEBUG_STREAM << "LiberaEventReceiver::write_T2ID(Tango::WAttribute &attr) entering... " << endl;
	//	Retrieve write value
	Tango::DevLong	w_val;
	attr.get_write_value(w_val);
	/*----- PROTECTED REGION ID(LiberaEventReceiver::write_T2ID) ENABLED START -----*/
	m_libera->UpdateScalar(attr_T2ID_read, w_val);
	
	/*----- PROTECTED REGION END -----*/	//	LiberaEventReceiver::write_T2ID
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void LiberaEventReceiver::read_T1ID(Tango::Attribute &attr)
{
	DEBUG_STREAM << "LiberaEventReceiver::read_T1ID(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(LiberaEventReceiver::read_T1ID) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_T1ID_read);
	
	/*----- PROTECTED REGION END -----*/	//	LiberaEventReceiver::read_T1ID
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void LiberaEventReceiver::write_T1ID(Tango::WAttribute &attr)
{
	DEBUG_STREAM << "LiberaEventReceiver::write_T1ID(Tango::WAttribute &attr) entering... " << endl;
	//	Retrieve write value
	Tango::DevLong	w_val;
	attr.get_write_value(w_val);
	/*----- PROTECTED REGION ID(LiberaEventReceiver::write_T1ID) ENABLED START -----*/
	m_libera->UpdateScalar(attr_T1ID_read, w_val);
	
	/*----- PROTECTED REGION END -----*/	//	LiberaEventReceiver::write_T1ID
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void LiberaEventReceiver::finalize_synchronization()
{
	DEBUG_STREAM << "LiberaEventReceiver::FinalizeSynchronization()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(LiberaEventReceiver::finalize_synchronization) ENABLED START -----*/
	...
	/*----- PROTECTED REGION END -----*/	//	LiberaEventReceiver::finalize_synchronization
}
//--------------------------------------------------------
/**
...
void LiberaEventReceiver::init_settings()
{
    ...
    m_libera->UpdateScalar(attr_T0idOut_read, t0idOut);
//    //T1
	...
	catch (...)
	{
		m_state = Tango::FAULT;
		//set_state(Tango::FAULT);
		m_status = "Error while initializing attributes";
		return;
	}
}
