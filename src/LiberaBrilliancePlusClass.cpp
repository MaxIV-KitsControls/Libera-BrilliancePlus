...
//--------------------------------------------------------
/**
 * method : 		FinalizeSynchronizationClass::execute()
 * description : 	method to trigger the execution of the command.
 *
 * @param	device	The device on which the command must be executed
 * @param	in_any	The command input data
 ...
 */
//--------------------------------------------------------
CORBA::Any *FinalizeSynchronizationClass::execute(Tango::DeviceImpl *device, TANGO_UNUSED(const CORBA::Any &in_any))
{
	cout2 << "FinalizeSynchronizationClass::execute(): arrived" << endl;
	((static_cast<LiberaBrilliancePlus *>(device))->finalize_synchronization());
	return new CORBA::Any();
}
...
void LiberaBrilliancePlusClass::attribute_factory(vector<Tango::Attr *> &att_list)
{
	...
	temperature_prop.set_description("Temperature of the hottest component on the timing \nmodule is returned.");
	temperature_prop.set_label("Timing Module Temperature");
	temperature_prop.set_unit("deg.C");
	//	standard_unit	not set for Temperature
	//	display_unit	not set for Temperature
	temperature_prop.set_format("%8d");
	//	max_value	not set for Temperature
	//	min_value	not set for Temperature
	temperature_prop.set_max_alarm("65");
	...
	t0delay_prop.set_label("T0 Delay");
	...
	//	Not Polled
	rtcdecoderswitch->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t0direction->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t0outputtype->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t0state->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	mgtout->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t0inmask->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t1inmask->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t2inmask->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	t0idout_prop.set_label("T0 Id Out");
	...
	//	Not Polled
	t0idout->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t1infunction->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t2infunction->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	mcinmask->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	mcinfunction->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t0duration->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	interlockid->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t2edgefalling->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t2edgerising->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t1edgefalling->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t1edgerising->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t2id->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t1id->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t1direction->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	...
	//	Not Polled
	t2direction->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
...
void LiberaBrilliancePlusClass::command_factory()
{
	...
	//	Command FinalizeSynchronization
	FinalizeSynchronizationClass	*pFinalizeSynchronizationCmd =
		new FinalizeSynchronizationClass("FinalizeSynchronization",
			Tango::DEV_VOID, Tango::DEV_VOID,
			"",
			"",
			Tango::OPERATOR);
	command_list.push_back(pFinalizeSynchronizationCmd);
