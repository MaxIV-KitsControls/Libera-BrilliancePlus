 ...
 */
//--------------------------------------------------------
void LiberaBrilliancePlus::read_Temperature(Tango::Attribute &attr)
{
	DEBUG_STREAM << "LiberaBrilliancePlus::read_Temperature(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(LiberaBrilliancePlus::read_Temperature) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_Temperature_read);
	
	/*----- PROTECTED REGION END -----*/	//	LiberaBrilliancePlus::read_Temperature
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void LiberaBrilliancePlus::finalize_synchronization()
{
	DEBUG_STREAM << "LiberaBrilliancePlus::FinalizeSynchronization()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(LiberaBrilliancePlus::finalize_synchronization) ENABLED START -----*/
	...
	/*----- PROTECTED REGION END -----*/	//	LiberaBrilliancePlus::finalize_synchronization
}
//--------------------------------------------------------
/**
