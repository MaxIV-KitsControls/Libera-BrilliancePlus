...
void LiberaBrilliancePlus::get_device_property()
{
	...
	dev_prop.push_back(Tango::DbDatum("EnablePM"));
	dev_prop.push_back(Tango::DbDatum("EnableFA"));
	...
	if (dev_prop.size()>0)
	{
		...
		//	Try to initialize EnablePM from class property
		cl_prop = ds_class->get_class_property(dev_prop[++i].name);
		if (cl_prop.is_empty()==false)	cl_prop  >>  enablePM;
		else {
			//	Try to initialize EnablePM from default device value
			def_prop = ds_class->get_default_device_property(dev_prop[i].name);
			if (def_prop.is_empty()==false)	def_prop  >>  enablePM;
		}
		//	And try to extract EnablePM value from database
		if (dev_prop[i].is_empty()==false)	dev_prop[i]  >>  enablePM;

		//	Try to initialize EnableFA from class property
		cl_prop = ds_class->get_class_property(dev_prop[++i].name);
		if (cl_prop.is_empty()==false)	cl_prop  >>  enableFA;
		else {
			//	Try to initialize EnableFA from default device value
			def_prop = ds_class->get_default_device_property(dev_prop[i].name);
			if (def_prop.is_empty()==false)	def_prop  >>  enableFA;
		}
		//	And try to extract EnableFA value from database
		if (dev_prop[i].is_empty()==false)	dev_prop[i]  >>  enableFA;
 ...
 */
//--------------------------------------------------------
void LiberaBrilliancePlus::enable_pm()
{
	DEBUG_STREAM << "LiberaBrilliancePlus::EnablePM()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(LiberaBrilliancePlus::enable_pm) ENABLED START -----*/
	if(m_libera != NULL)
 {
	//	Add your own code
	m_signalPM->Enable();
 }
	/*----- PROTECTED REGION END -----*/	//	LiberaBrilliancePlus::enable_pm
}
//--------------------------------------------------------
/**
 ...
 */
//--------------------------------------------------------
void LiberaBrilliancePlus::disable_pm()
{
	DEBUG_STREAM << "LiberaBrilliancePlus::DisablePM()  - " << device_name << endl;
	/*----- PROTECTED REGION ID(LiberaBrilliancePlus::disable_pm) ENABLED START -----*/
		if(m_libera != NULL)
 {
	//	Add your own code
	m_signalPM->Disable();
}
	/*----- PROTECTED REGION END -----*/	//	LiberaBrilliancePlus::disable_pm
}
//--------------------------------------------------------
/**
...
void LiberaBrilliancePlus::init_settings()
{
    ...
    enableDD ? enable_dd() : disable_td(); //m_signalDdc, m_signalDdcRaw
    enableTD ? enable_td() : disable_td(); //m_signalTdp
    enableSP ? enable_sp() : disable_sp(); //m_signalSP
    enablePM ? enable_pm() : disable_pm(); //m_signalPM
