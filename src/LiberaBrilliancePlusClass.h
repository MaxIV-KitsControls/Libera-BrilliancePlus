...
public:
	...
	~TemperatureAttrib() {};
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<LiberaBrilliancePlus *>(dev))->read_Temperature(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<LiberaBrilliancePlus *>(dev))->is_Temperature_allowed(ty);}
};
...
//	Command FinalizeSynchronization class definition
class FinalizeSynchronizationClass : public Tango::Command
{
public:
	FinalizeSynchronizationClass(const char   *name,
	               Tango::CmdArgType in,
				   Tango::CmdArgType out,
				   const char        *in_desc,
				   const char        *out_desc,
	...
	FinalizeSynchronizationClass(const char   *name,
				   ...
				   Tango::CmdArgType out)
	:Command(name,in,out)	{};
	~FinalizeSynchronizationClass() {};
	
	virtual CORBA::Any *execute (Tango::DeviceImpl *dev, const CORBA::Any &any);
	virtual bool is_allowed (Tango::DeviceImpl *dev, const CORBA::Any &any)
	{return (static_cast<LiberaBrilliancePlus *>(dev))->is_FinalizeSynchronization_allowed(any);}
};
